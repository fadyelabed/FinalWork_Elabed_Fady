<template>
  <div class="tomorrowland" id="top">
    ...
    <section class="tmrw-intro">
        <div class="wrapping-content">
            <article>
                <p>Tomorrowland probably known as one of the biggest festivals around the globe launched their first ever digital edition. Tomorrowland: Around the World took place over the weekend, being a two-day digital experience, not located in Boom this time, but on the Pāpiliōnem island. This digital solution was made due to covid restrictions. More than 60 of the most prominent artists were in attendance to perform their newest songs on one of the 8 different stages.</p>
            </article>
        </div>
    </section>
    <section class="tmrw-highlights">
        <div class="wrapping-content">
            <h2>highlights in numbers:</h2>
        <section>
            <article>
        ...
        <figure>
            <img src="@/assets/tmrwland1.jpg" alt="">
            <img src="@/assets/tmrwland2.jpg" alt="">
            <img src="@/assets/tmrwland3.jpg" alt="">
            <img src="@/assets/tmrwland4.jpg" alt="">
        </figure>
    </section>
